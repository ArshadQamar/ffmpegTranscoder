...
def transcoding_start(job_id):
    ...
    try:
        ...
        if channel.output_type == 'hls':
            ...
            ffmpeg_command += ['-mpegts_service_id',str(channel.service_id), '-f', 'mpegts', '-ttl', '50', f'udp://{channel.output_multicast_ip}?localaddr={channel.output_network}&pkt_size=1316']
